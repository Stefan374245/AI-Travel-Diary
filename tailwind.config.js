...
export default {
  ...
  theme: {
    extend: {
      ...
      // Font Weights - Klare Abstufungen
      fontWeight: {
        normal: '400',
        medium: '500',
        semibold: '600',
      ...
      // Spacing System - 4px Basis für vertikalen Rhythmus
      spacing: {
        'px': '1px',
        '0': '0',
        '0.5': '0.125rem',  // 2px
      ...
      // Colors - Erweiterte, harmonische Palette
      colors: {
        // Primärfarbe - Indigo
        primary: {
          50: '#eef2ff',
