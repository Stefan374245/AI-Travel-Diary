  ...
  return (
    <TutorialProvider autoStart={true}>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex-1 flex flex-col items-center">
                ...
                <p className="text-center text-slate-500 mt-1 text-sm">Dein smarter Begleiter für unvergessliche Reisen & Spanischlernen</p>
              </div>
      ...
      <main className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="bg-white p-2 sm:p-3 rounded-lg shadow-md mb-6 sticky top-[110px] sm:top-[122px] z-10" data-tutorial="tab-bar">
